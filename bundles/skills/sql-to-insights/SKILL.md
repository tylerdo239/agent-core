...
description: Turns SQL query results into a decision-ready business narrative with a headline finding, drivers, recommendation, and suitable chart. Use when the user asks what query results mean or wants a non-technical summary. It complements DuckDB query execution; use explore-data for open-ended exploration and data-scientist for a full analysis report.
